...
Yeni sürümleme mantığından dolayı artık bu dosya rafa kaldırıldı. Yeni CHANGELOG.md üzerinden güncellemeler takip edilebilir.
...
- Pozisyon sınıfları için '{top|left|bottom|right|start|end}-full' sınıfları eklendi.

### Düzeltmeler

- Slayt değişimi sonrasında slaytın autoplay özelliğinin tekrar devreye girmesinde yaşanan zaman aşımı süresi sorunu giderildi.
